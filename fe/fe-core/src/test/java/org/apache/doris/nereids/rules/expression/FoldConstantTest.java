...
class FoldConstantTest extends ExpressionRewriteTestHelper {
    ...
    void testFoldDate() {
        ...
        Assertions.assertEquals(new DateTimeV2Literal("0001-01-01 0:02:02"), rewritten);
        // fail to fold, because the result is out of range
        minuteSecondAdd = new MinuteSecondAdd(DateTimeV2Literal.fromJavaDateType(LocalDateTime.of(9999, 12, 31, 23, 59, 1), 0),
            new VarcharLiteral("1:1"));
        rewritten = executor.rewrite(minuteSecondAdd, context);
